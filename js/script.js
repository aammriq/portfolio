...
const projectsData = {
    1: {
        title: "El Fandry Make Up & Wedding Logo",
        category: "Logo & Branding",
        client: "El Fandry",
        year: "2026",
        description: "Desain logo profesional dan elegan untuk kebutuhan tata rias pengantin dan dokumentasi pernikahan, menampilkan simbol kupu-kupu bernuansa mewah.",
        colors: ["#3B82F6", "#EC4899", "#000000", "#FFFFFF"],
        specs: [
            "File Master: Adobe Illustrator (.AI), CorelDRAW (.CDR), PNG Transparent",
            "Variasi Logo: Varian Warna Utama & Monokrom",
            "Resolusi: Vector Skala Tanpa Batas (Infinite DPI)",
            "Lisensi: Hak Cipta Komersial Penuh"
        ]
    },
    2: {
        title: "Desain Porselen Construction Logo",
        category: "Logo & Konstruksi",
        client: "CV Porselen",
        year: "2025",
        description: "Konsep logo perusahaan bidang konstruksi bangunan dengan ilustrasi bentuk rumah bergaris dinamis serta tipografi tebal yang kokoh.",
        colors: ["#3B82F6", "#FFFFFF", "#000000"],
        specs: [
            "File Master: AI, EPS, PDF, High-Res PNG",
            "Kategori: Logo Perusahaan / Kontraktor",
            "Standar Cetak: CMYK & RGB Ready"
        ]
    },
    3: {
        title: "Kemeja PDH KDMP Desa Pakisrejo",
        category: "PDH / PDL Design",
        client: "KDMP Desa Pakisrejo",
        year: "2026",
        description: "Rancangan Pakaian Dinas Harian (PDH) menggunakan kombinasi warna navy dan putih, lengkap dengan saku dada, emblem bendera, dan layout teks bordir.",
        colors: ["#1E293B", "#FFFFFF", "#DC2626", "#64748B"],
        specs: [
            "Mockup: Layout Teknis 2D Tampak Depan & Belakang",
            "Panduan Bordir: Spesifikasi Ukuran Penempatan Logo",
            "Bahan Rekomendasi: American Drill / Nagata Drill"
        ]
    },
    4: {
        title: "Stiker Komunitas Seni Ananta",
        category: "Sticker & Merchandise",
        client: "Ananta Community",
        year: "2025",
        description: "Desain stiker merchandise bertema seni dengan ilustrasi alat musik tradisional dan tipografi kustom bergaya modern-edgy.",
        colors: ["#EC4899", "#F59E0B", "#FFFFFF", "#000000"],
        specs: [
            "File Cutline: Vector Cut-Contour Garis Potong",
            "Bahan Cetak: Vinyl Glossy Laminasi Doff Tahan Air",
            "Format: CorelDRAW / Illustrator Siap Cetak"
        ]
    },
    5: {
        ...
        year: "2026",
        description: "Spanduk panggung utama ukuran 5x2.5 meter untuk event pameran seni dan musik dengan tipografi besar dan jelas.",
        colors: ["#1E1B4B", "#3B82F6", "#06B6D4", "#E0E7FF"],
        specs: [
            "Dimensi File: 500cm x 250cm (300 DPI Skala 1:10)",
            "Color Profile: CMYK Print Ready Profile",
            "Marginal Safety Zone: Bleed 5cm tiap sisi"
        ]
    },
    6: {
        ...
        year: "2026",
        description: "Desain carousel Instagram 5 slide yang saling menyambung untuk meningkatkan interaksi dan daya tarik visual promosi produk.",
